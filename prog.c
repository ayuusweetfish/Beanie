...
int main(int T, char *argv[])
{
  ...
  T && (a = fopen(argv[1], "wb")) ? setbuf(a, 0) : (w(2368795716511872974), w(8495621981700207332), w(7440143561770350704), w(2367120232991520481), w(8421053345252782818), w(45414784422944));
  ...
  while (T = 2) {
    ...
    for (int p = (w((T = E = M(getchar()))[(long long []){0, 145*145*';', 457848661928, 354729598760, 5837632671028316, 5837641771095132, 0xa52aaf2dbca2e7e}]), (('3'-T*5)*T-154)*T+144), l = 3490 + ((T > 1) + (T > 2)) * 2400, i = (p && (p = 1309 / p)) & !E; a && fflush(a) || i - l; i += !a || 2 > fwrite(&S, 2, !!T, a))
